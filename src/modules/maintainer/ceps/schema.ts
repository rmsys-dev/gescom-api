import { z } from "zod";
import { cepNumberSchema, uuidIdSchema } from "../shared/address-schemas.js";
...
export type CreateMaintainerCepInput = z.infer<typeof createCepSchema>;
export type PatchMaintainerCepInput = z.infer<typeof patchCepSchema>;
