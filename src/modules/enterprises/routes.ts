...
import { enterpriseLogoController } from "./logo/controller.js";
import { uploadEnterpriseLogo } from "./logo/upload.js";
import {
...
enterprisesRouter.delete(
  ...
  enterpriseLogoController.remove,
);
