...
import { loadPrintLogoSrc } from "../print/load-print-logo.js";
import {
  budgetPdfFilename,
...
export class SalesServiceCore {
  ...
  public async getPrintHtml(
    ...
    const [enterprise, logoSrc] = await Promise.all([
      enterprisesService.getById(enterpriseId),
      loadPrintLogoSrc(enterpriseId),
    ]);
