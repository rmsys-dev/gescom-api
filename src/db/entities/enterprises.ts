...
import { bytea, tz } from "../functions.js";
...
/** Logo de impressão por empresa (1:1). Soft delete da empresa não remove a logo. */
export const enterprisesLogos = pgTable("enterprises_logos", {
  enterpriseId: uuid("enterprise_id")
    .primaryKey()
    .references(() => enterprises.id, { onDelete: "restrict" }),
