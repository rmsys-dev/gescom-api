...
export const productsNbsParamsSchema = z
  .object({
    productsNbsId: uuidSchema("productsNbsId"),
  })
  .strict();

export type CreateMaintainerProductsNbsInput = z.infer<
  typeof createProductsNbsSchema
>;
export type PatchMaintainerProductsNbsInput = z.infer<
  typeof patchProductsNbsSchema
>;
