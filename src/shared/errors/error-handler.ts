...
const isMulterFileTooLarge = (error: unknown): error is MulterLimitError =>
  error instanceof Error &&
  (error as MulterLimitError).code === "LIMIT_FILE_SIZE";
...
export const errorHandler: ErrorRequestHandler = (err, req, res, _next) => {
  ...
  if (isBodyParserPayloadTooLarge(err) || isMulterFileTooLarge(err)) {
